...
window.addEventListener('DOMContentLoaded', function (e) {
    ...
    password.addEventListener('input', (e) => {
        if (password.value == '') {
            ...
            password.parentElement.classList.add('error');
            confirmPassword.innerHTML = 'Password must be at least 8 characters that include at least 1 lowercase, 1 uppercase, 1 special character and 1 number';
        } else {
    ...
    if (allTrue) {
        ...
        this.alert('Enter all necessary information!')
    }
});
